						...
						<div class="row">
							<div class="col-md-9 col-lg-8 mx-auto">
								...
								<form action="../TiendaController" method="POST">
									...
									<div class="form-label-group">
										<input type="text" id="inputLema" name="lema"
											class="form-control" placeholder="Lema" required autofocus>
									...
									<div class="form-label-group">
										<input type="input" id="inputPropietario" name="propietario"
											class="form-control" placeholder="Propietario" required>
										<label for="inputPropietario">Propietario</label>
									</div>
									<div class="form-label-group">
										<input type="input" id="inputFacebook" name="facebook"
											class="form-control" placeholder="Facebook" required>
										<label for="inputFacebook">Facebook</label>
									</div>
									<div class="form-label-group">
										<input type="input" id="inputWeb" name="web"
											class="form-control" placeholder="Web" required> <label
									...
									<button value="registro" name="accion"
